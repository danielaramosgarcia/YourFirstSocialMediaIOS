...
class HomeViewModel : ObservableObject{
    ...
    func getHome() {
        ...
        home = HomeModel(titulo: "FemCoding Challenge 2023 ", descripcion: "Hoy volamos a Tijuana en camino al FemCoding Challenge 2023 organizado por Enactus. Estamos super emocionadas de por fin poderles mostrar nuestra app a todos. USinSTEM! @danielaramosgarcia @valelimon", nombreImagenPost: "profileClaudia", NombrePersona: "@clauarcienegam", nombreImagen: "clau", questions: 8, isHer: false)
        arrHome.append(home)
        ...
        home = HomeModel(titulo: "Inicio de clases", descripcion: "Estoy super emocionada de empezar mis clases como inginiera de Software, ¿Sabías que solo 3 de cada 10 personas estudiando ingeniería son mujeres?", nombreImagenPost: "PostClau", NombrePersona: "@clauarcienegam", nombreImagen: "profileClaudia", questions: 13, isHer: false)
        arrHome.append(home)
